          ...
          cols={[
            {
              ...
              r: (v, r) => (
                <span style={{ fontWeight: 700 }}>
                  {String(v)} {r.credit && <Badge label='Credit' color='red' />}
                </span>
              ),
            },
            {
                ...
                <div style={{ display: 'flex', gap: 6 }}>
                  {Number(r.outstanding) > 0 && (
                    <Btn
                      small
                      variant='success'
                      onClick={() => openCollect(r as unknown as Customer)}
                    >
                      Collect
                    </Btn>
                  )}
      ...
      {addModal && (
        <Modal title='Add New Customer' onClose={closeAdd}>
          ...
          >
            ...
            />
            <span
              style={{ fontSize: 13.5, fontWeight: 600, color: 'var(--ink2)' }}
            >
              Credit customer
            </span>
          </label>
      ...
      {payModal && (
        ...
        >
          ...
          >
            ...
            <span
              style={{ fontSize: 20, fontWeight: 800, color: 'var(--red)' }}
            >
              ₹{payModal.outstanding.toLocaleString()}
            </span>
          </div>
          <Field
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
            <Btn variant='ghost' onClick={closeCollect}>
              Cancel
            </Btn>
            <Btn variant='success' onClick={recordPayment}>
              ✓ Record
            </Btn>
          </div>
        </Modal>
